...
import type { FinanceCategory, FinanceCategoryType } from "@/modules/finance/types";
...
<template>
  <BaseModal :open="open" title="Categories" max-width="max-w-lg" height-class="max-h-[65vh]" @close="emit('close')">
    <template #body>
      <!-- Search -->
